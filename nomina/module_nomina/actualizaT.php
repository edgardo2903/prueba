...
//Lo que Hace es Buscar los datos del trabajador con la cedula indicaa
	...
	$valoresQ = mysql_query("SELECT nombres, apellidos, cedula, sueldo, cargo from trab_qui where cedula like '". $cedulaN."'")or die("No se conecto");
	if(mysql_num_rows($valores)>0){
		$valores2 = mysql_fetch_array($valores);
	}
	else{
		$valores2 = mysql_fetch_array($valoresQ);
